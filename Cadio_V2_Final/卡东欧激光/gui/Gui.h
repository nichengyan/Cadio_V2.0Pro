...
void Gui_DrawRectangleRound(Page *p,int sx,int sy,int sizex,int sizey,int r,uchar op);//画圆角矩形框   圆角矩形外接矩形框的左上角p(sx,sy),横向直线部分sizex，纵向直线部分sizey,圆弧半径r
...
void Gui_DrawBmpColorRev(Page *p,int sx,int sy,int sizex,int sizey,uchar BMP[]);//画反色位图
